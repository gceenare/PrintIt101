...
class AddressFactoryTest {
    ...
    public void testCreateValidPostalAddress() {
        Address postalAddress = AddressFactory.createPostalAddress(
                123, "Maple Street", "Cape Town", "Western Cape", "8001", "South Africa"
        );
    ...
    public void testCreateInvalidPostalAddress() {
        Address postalAddress = AddressFactory.createPostalAddress(
                123, "", "Cape Town", "Western Cape", "8001", "South Africa"
        );
    ...
    public void testCreateValidResidentialAddress() {
        Address resAddress = AddressFactory.createResidentialAddress(
                456, "Sunset Villas", 12, "Ocean Drive", "Durban", "KZN", "4001", "South Africa"
        );
    ...
    public void testCreateValidBusinessAddress() {
        Address bizAddress = AddressFactory.createBusinessAddress(
                789, "Tech Park", "Main Road", "Joburg", "Gauteng", "2000", "South Africa"
        );
    ...
    public void testCreateInvalidBusinessAddress() {
        Address bizAddress = AddressFactory.createBusinessAddress(
                789, "", "Main Road", "Joburg", "Gauteng", "2000", "South Africa"
        );
    ...
    public void testCreateValidFullAddress() {
        Address fullAddress = AddressFactory.createFullAddress(
                101, "Global Towers", 33, 444, "Nelson Street", "Pretoria", "Gauteng", "0002", "South Africa"
        );
    ...
    public void testCreateInvalidFullAddress() {
        Address fullAddress = AddressFactory.createFullAddress(
                101, null, 33, 0, "Nelson Street", "Pretoria", "", "0002", "South Africa"
        );
